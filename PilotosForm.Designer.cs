...
namespace SistemaRepartoG4
{
    partial class PilotosForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtBuscar.ForeColor = SystemColors.GrayText; // Color gris para el placeholder
            ...
            int startX = this.ClientSize.Width - marginRight - (4 * buttonSize + 3 * buttonSpacing);
            int buttonY = this.ClientSize.Height - marginBottom - buttonSize;

            this.btnAgregar.Location = new Point(startX, buttonY);
            this.btnEditar.Location = new Point(startX + buttonSize + buttonSpacing, buttonY);
            this.btnGuardar.Location = new Point(startX + 2 * (buttonSize + buttonSpacing), buttonY);
            this.btnEliminar.Location = new Point(startX + 3 * (buttonSize + buttonSpacing), buttonY);
